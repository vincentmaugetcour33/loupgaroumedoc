    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                ...
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'VM\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
                }
                ...
                if ($pathinfo === '/login_check') {
                    ...
                    return array (  '_controller' => 'VM\\UserBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
                }
            ...
            if ($pathinfo === '/logout') {
                return array (  '_controller' => 'VM\\UserBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
            }
