    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/commentaire')) {
            ...
            if (preg_match('#^/commentaire(?:/(?P<page>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'vm_blog_com_list')), array (  '_controller' => 'VM\\BlogBundle\\Controller\\DefaultController::comlistAction',  'page' => 1,));
            }
