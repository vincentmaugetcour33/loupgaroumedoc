...
class __TwigTemplate_5f95ee4e173909af2e9290b3804634cb extends Twig_Template
{
 ...
 ";
      ...
      <a href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("vm_blog_commentaire_list", array("page" => $this->getContext($context, "current_page"), "tri" => "asc")), "html", null, true);
        echo "\">Retour</a> 
